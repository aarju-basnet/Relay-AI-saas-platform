  ...
  return (
    <div className="w-full h-full min-h-screen bg-white text-ink p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-ink">Team Management</h1>
        ...
        <div className="rounded-2xl border border-border bg-white p-5 shadow-sm">
          ...
          {seatsFull ? (
            <p className="text-xs text-ink-muted">
              You've used all {seatCap} seats on your current plan.{" "}
              <Link to="/pricing" className="text-copper hover:text-copper/80 font-medium">
                Upgrade
              </Link>{" "}
              for more room.
            </p>
          ...
          <p className="mt-3 text-[11px] text-ink-faint leading-5">
            ...
            They set their own password — nothing is generated on their behalf.
          </p>
        </div>
      )}
